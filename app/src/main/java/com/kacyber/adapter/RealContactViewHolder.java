...
public class RealContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public RealContactViewHolder(View itemView, UserItemClickListener userItemClickListener) {
        super(itemView);
