...
import com.kacyber.common.ViewHolder;
...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height) {
        ...
        mScreenWidth = wm.getDefaultDisplay().getWidth() + 49;
        mScreenHeight = wm.getDefaultDisplay().getHeight() + 36;
